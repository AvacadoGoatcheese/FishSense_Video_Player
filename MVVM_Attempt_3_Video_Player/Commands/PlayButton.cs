    ...
    public class PlayButton : ICommand
    {
        ...
        public void Execute(object? parameter)
        {
            if (video_num == 1)
            {
                ...
                {
                    view_model_two_videos.is_playing_v1 = true;
                }
                else if (view_model_one_video != null)
                {
                    view_model_one_video.is_playing = true;
                }
            }
            else if (video_num == 2)
            {
                if (view_model_two_videos != null)
                {
                    view_model_two_videos.is_playing_v2 = true;
                }
            }
        }
        }
